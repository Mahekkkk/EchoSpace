...
$user_id = $_GET['uid']; // Retrieve the user ID from the URL query parameter
// Construct the folder paths
$user_folder_path = '../../../  files/media' . $user_id . '_files'; // e.g., media34_files, mediaz_files
$user_trash_folder_path = $user_folder_path . '/trash';
// Create the user folder if it doesn't exist
if (!is_dir($user_folder_path)) {
    mkdir($user_folder_path, 0777, true);
}
// Create the trash folder inside the user folder if it doesn't exist
